---
name: take-the-brief
description: Intent-briefing gateway for delegated work. Use when Krish explicitly asks to be interviewed before execution, transfers end-to-end ownership, says to take work off his plate or act like an AI employee, or delegates new, high-stakes, or ambiguous work whose plausible interpretations would lead to materially different execution. Ask up to five high-signal questions one at a time, then produce an amnesia-proof intent summary and a short proposed plan before work starts. An explicit interview request takes precedence. Otherwise do not use for clear single-step work, urgent work needing immediate action, routine repeats, work already briefed in the conversation, customer/user interviews, or durable taste and quality-standard elicitation; use ctrl-intake for that last purpose.
---
