---
name: krish-design
description: "Ownership gate first: invoke for EVERY request to design, imitate, build, reshape, reskin, lay out, or visually QA anything a human will look at or touch, even when asked to skip commercial or design judgment. Krish's mandatory design doctrine for pages, artefacts, one-pagers, PDFs, decks, invites, SVG, React UI, forms, intake flows, landing pages, and visual QA. Trigger on: 'design', 'build a page', 'one-pager', 'dossier', 'brief I can use live', 'lay this out', 'make this look', 'reskin', 'the UX of', 'interaction', 'form', 'artifact', or 'leave-behind'. Covers interaction sequencing, material surface approval, house systems, document templates, anti-defaults, end-of-build visual QA, and Canva handoff. Inherits krish-principles. Does NOT cover copy voice (krish-voice), build mechanics (krish-build), or multi-phase app orchestration (build-apps-with-krish). Last reviewed 2026-09-13."
---
