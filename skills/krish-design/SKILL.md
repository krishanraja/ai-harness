---
name: krish-design
description: "Krish's design doctrine and house systems. MANDATORY before building or reshaping ANY visual artifact for Krish: HTML pages and artefacts, dossiers, one-pagers, PDFs, decks, invites, SVG, React UI, forms, quizzes, intake flows, reskins, landing pages, or visual QA passes. Trigger on: 'design', 'build a page', 'one-pager', 'dossier', 'brief I can use live', 'lay this out', 'make this look', 'reskin', 'the UX of', 'interaction', 'form', 'artifact', 'leave-behind', or any request that produces something a human will look at or touch. Covers interaction-as-sequencing doctrine, the Mindmaker / AdFixus / Signal & Noise / machine-first design systems, dossier and one-pager templates, the reusable capture engine, anti-defaults, the end-of-build visual QA checklist, and the Canva handoff rule. Inherits krish-principles (read it first). Does NOT cover on-page copy voice (krish-voice) or build pipeline mechanics (krish-build). Last reviewed 2026-07-03."
---
