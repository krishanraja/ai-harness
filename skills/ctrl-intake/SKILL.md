---
name: ctrl-intake
description: "Elicit a named person's reusable quality or taste standard from their grading of real work. Use for standards onboarding, triadic or repertory-grid sessions, self-serve sorts, approved/rejected comparisons, transcript-to-candidate extraction, a voice standard grounded in the subject's own corpus, or repairing an inferred profile. Also use to refuse skipped grading, one-source personality inference, unscoped private-material reuse, holdout contamination, or supplied desired constructs. Exclude one-task briefing (`take-the-brief`), compilation (`ctrl-compile`), packaging (`ctrl-build`), review (`ctrl-check`), and evidence-led standard changes (`ctrl-capture`)."
---
