...
<!-- krish-canon:start release=v2026.09.13.1 sha=fc393953615d rendered=2026-09-13 -->
## Krish canon

Rendered from `krishanraja/ai-harness` at release v2026.09.13.1. Nothing inside these
...
**This repository's own rules:** `AGENTS.md`, `contract/krish-operating-contract.md`, `contract/skill-routing-contract.md`
<!-- krish-canon:end -->
