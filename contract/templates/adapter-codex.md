...
Canonical user skills are exposed through `{{codex_skills_root}}`. Use `mindmake-os` for mind/make OS architecture or operations, `mindmake` for the commercial business, `krish-voice` for outbound writing, and `ux-testing-agent` for app or repository QA.
